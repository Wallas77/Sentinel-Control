 ...
 */
@Entity
@Table(name = "ACCESS_CONTROLS", indexes = @Index(columnList = "name,id_number"))
@Data
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode(callSuper=false)
public class AccessControl extends BaseSerializedEntity{
    ...
    @OneToMany(fetch = FetchType.LAZY, cascade = CascadeType.ALL, mappedBy = "accessControl", orphanRemoval = true)
    private List<AccessControlObject> accessControlObjects = new ArrayList<>();
