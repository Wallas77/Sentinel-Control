...
public class ProfileManager {
    ...
    public PagedResponse<Profile> getProfile(Profile filter, Paging paging){
        ...
        List<Profile> result = query.setFirstResult((int) pageable.getOffset())
        ...
        return new PagedResponse<Profile>((int) page.getTotalElements(),page.getTotalPages(), paging.getPage(), paging.getPageSize(), page.getContent());   
    }
